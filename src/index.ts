...
class Branch {
  ...
  findBranchByName(customerName: string) {
    const findCustomer = this.customers.find((customer) => {
...
class Bank {
  ...
  findCustomerByName(branchName: Branch, customerName:string) {
...
console.log(arizonaBank.findCustomerByName(westBranch, customer1.getName()));
